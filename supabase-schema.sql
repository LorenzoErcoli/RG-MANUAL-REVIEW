...
comment on table public.review_contribution_events is
  'Append-only event log for RG Manual Review. Public clients can only insert; reading and administration remain available through the Supabase dashboard or service role.';
